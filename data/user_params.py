...
class UserTab(object):
    ...
    def __init__(self):
        ...
        param_name2 = Button(description='save_interval_after_therapy_start', disabled=True, layout=name_button_layout)
        ...
        param_name3 = Button(description='immune_o2_relative_uptake', disabled=True, layout=name_button_layout)
        ...
        param_name5 = Button(description='immune_motility_persistence_time', disabled=True, layout=name_button_layout)
        ...
        param_name6 = Button(description='immune_migration_speed', disabled=True, layout=name_button_layout)
        ...
        param_name7 = Button(description='immune_migration_bias', disabled=True, layout=name_button_layout)
        ...
        param_name8 = Button(description='immune_relative_adhesion', disabled=True, layout=name_button_layout)
        ...
        param_name9 = Button(description='immune_relative_repulsion', disabled=True, layout=name_button_layout)
        ...
        param_name10 = Button(description='immune_kill_rate', disabled=True, layout=name_button_layout)
        ...
        param_name11 = Button(description='immune_attachment_lifetime', disabled=True, layout=name_button_layout)
        ...
        param_name12 = Button(description='immune_attachment_rate', disabled=True, layout=name_button_layout)
        ...
        param_name13 = Button(description='elastic_coefficient', disabled=True, layout=name_button_layout)
        ...
        param_name14 = Button(description='number_of_immune_cells', disabled=True, layout=name_button_layout)
        ...
        param_name15 = Button(description='initial_min_immune_distance_from_tumor', disabled=True, layout=name_button_layout)
        ...
        param_name16 = Button(description='thickness_of_immune_seeding_region', disabled=True, layout=name_button_layout)
        ...
        param_name17 = Button(description='tumor_radius', disabled=True, layout=name_button_layout)
        ...
        param_name18 = Button(description='tumor_mean_immunogenicity', disabled=True, layout=name_button_layout)
        ...
        param_name19 = Button(description='tumor_immunogenicity_standard_deviation', disabled=True, layout=name_button_layout)
        ...
        param_name20 = Button(description='oncoprotein_saturation', disabled=True, layout=name_button_layout)
        ...
        param_name21 = Button(description='oncoprotein_threshold', disabled=True, layout=name_button_layout)
        ...
        param_name22 = Button(description='max_attachment_distance', disabled=True, layout=name_button_layout)
        ...
        param_name23 = Button(description='min_attachment_distance', disabled=True, layout=name_button_layout)
        ...
        units_button5 = Button(description='min', disabled=True, layout=units_button_layout) 
        ...
        units_button22 = Button(description='micron', disabled=True, layout=units_button_layout) 
        ...
        desc_button2 = Button(description='save (output) interval after therapy begins', disabled=True, layout=desc_button_layout) 
        desc_button2.style.button_color = 'tan'
        desc_button3 = Button(description='', disabled=True, layout=desc_button_layout) 
        desc_button3.style.button_color = 'lightgreen'
        desc_button4 = Button(description='descr', disabled=True, layout=desc_button_layout) 
        ...
        row2 = [param_name2, self.save_interval_after_therapy_start, units_button2, desc_button2] 
        row3 = [param_name3, self.immune_o2_relative_uptake, units_button3, desc_button3] 
        row4 = [param_name4, self.immune_apoptosis_rate, units_button4, desc_button4] 
        row5 = [param_name5, self.immune_motility_persistence_time, units_button5, desc_button5] 
        row6 = [param_name6, self.immune_migration_speed, units_button6, desc_button6] 
        row7 = [param_name7, self.immune_migration_bias, units_button7, desc_button7] 
        row8 = [param_name8, self.immune_relative_adhesion, units_button8, desc_button8] 
        row9 = [param_name9, self.immune_relative_repulsion, units_button9, desc_button9] 
        row10 = [param_name10, self.immune_kill_rate, units_button10, desc_button10] 
        row11 = [param_name11, self.immune_attachment_lifetime, units_button11, desc_button11] 
        row12 = [param_name12, self.immune_attachment_rate, units_button12, desc_button12] 
        row13 = [param_name13, self.elastic_coefficient, units_button13, desc_button13] 
        row14 = [param_name14, self.number_of_immune_cells, units_button14, desc_button14] 
        row15 = [param_name15, self.initial_min_immune_distance_from_tumor, units_button15, desc_button15] 
        row16 = [param_name16, self.thickness_of_immune_seeding_region, units_button16, desc_button16] 
        row17 = [param_name17, self.tumor_radius, units_button17, desc_button17] 
        row18 = [param_name18, self.tumor_mean_immunogenicity, units_button18, desc_button18] 
        row19 = [param_name19, self.tumor_immunogenicity_standard_deviation, units_button19, desc_button19] 
        row20 = [param_name20, self.oncoprotein_saturation, units_button20, desc_button20] 
        row21 = [param_name21, self.oncoprotein_threshold, units_button21, desc_button21] 
        row22 = [param_name22, self.max_attachment_distance, units_button22, desc_button22] 
        row23 = [param_name23, self.min_attachment_distance, units_button23, desc_button23] 
